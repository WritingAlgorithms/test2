...
function gameLoop(delta) {
    ...
    /*var prevx = ball2.sprite.x;
    var prevy = ball2.sprite.y;
    var pprevx = player.sprite.x;
    var pprevy = player.sprite.y;*/
    ...
    let hit2 = bump.hit(
        ...
        function(collision, otherball){
            ...
            //player.sprite.x = pprevx;
            //player.sprite.y = pprevy;
           // ball2.sprite.x = prevx;
           // ball2.sprite.y = prevy;
